...
\x1b[33mUsage:\x1b[0m
  ...
  aih account import [dir] [--parallel N] [--limit N] [--dry-run]\x1b[90mAuto import from accounts/<provider> roots\x1b[0m
...
if (cmd === 'account') {
  ...
  if (action === 'help' || action === '--help' || action === '-h' || !action) {
    console.log('\x1b[90mUsage:\x1b[0m aih account import [sourceDir] [--parallel <1-32>] [--limit <n>] [--dry-run]');
    process.exit(0);
  }
  if (action !== 'import') {
