...
\x1b[33mNotes:\x1b[0m
  ...
  - Default backend is codex-adapter (Codex responses adapter via chatgpt backend API).
...
\x1b[33mAdvanced (optional):\x1b[0m
  aih server serve [--host <ip>] [--port <n>] [--backend codex-adapter|openai-upstream] [--provider codex|gemini|auto] [--upstream <url>] [--codex-base-url <url>] [--codex-models <csv>] [--proxy-url <url>] [--no-proxy <hosts>] [--strategy round-robin|random] [--session-affinity-ttl-ms <ms>] [--session-affinity-max <n>] [--client-key <key>] [--management-key <key>] [--cooldown-ms <ms>] [--max-attempts <n>] [--upstream-timeout-ms <ms>]
