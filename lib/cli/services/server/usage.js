...
\x1b[33mNotes:\x1b[0m
  ...
  - Default backend is openai-upstream (direct upstream gateway; no local codex exec process).
...
\x1b[33mAdvanced (optional):\x1b[0m
  aih server serve [--host <ip>] [--port <n>] [--backend openai-upstream] [--provider codex|gemini|auto] [--upstream <url>] [--strategy round-robin|random] [--session-affinity-ttl-ms <ms>] [--session-affinity-max <n>] [--client-key <key>] [--management-key <key>] [--cooldown-ms <ms>] [--max-attempts <n>] [--upstream-timeout-ms <ms>]
