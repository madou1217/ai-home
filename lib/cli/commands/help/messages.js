...
\x1b[33mUsage:\x1b[0m
  ...
  aih account import [sources...] [--dry-run]\x1b[90mLegacy alias of unified import; supports dirs, zip, cliproxyapi\x1b[0m
  aih <cli> import [sources...] [--dry-run]\x1b[90mImport this provider from dirs, zip, or cliproxyapi\x1b[0m
  aih <cli> account import [sources...] [--dry-run]\x1b[90mLegacy alias of the same provider import\x1b[0m
...
\x1b[33mAdvanced:\x1b[0m
  ...
  aih import [provider] [sources...] [-f <folder>] [--dry-run]\x1b[90mImport mixed dirs/zip/cliproxyapi sources; -f points to zip subfolder\x1b[0m
`);
  }
...
\x1b[33mUsage:\x1b[0m
  ...
  aih ${cliName} import [sources...] [--dry-run]  \x1b[90mImport this provider from dirs, zip, or cliproxyapi\x1b[0m
  aih ${cliName} account import [sources...] [--dry-run]  \x1b[90mLegacy alias of the same provider import\x1b[0m
