...
function ensureSessionAffinity(state) {
  ...
  if (!(state.sessionAffinity.codex instanceof Map)) state.sessionAffinity.codex = new Map();
  if (!(state.sessionAffinity.gemini instanceof Map)) state.sessionAffinity.gemini = new Map();
